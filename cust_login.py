...
def login_menu(user_id,id,password,pos,user_details): #customer login menu
...
def view_data(user_id,id,password,pos,user_details): #view customer details
...
def update_data(user_id,id,password,pos,user_details): #update customer details
