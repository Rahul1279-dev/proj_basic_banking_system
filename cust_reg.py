...
def signup(user_id,password,user_details):  #customer signup
...
def add_data(user_id,password,user_details,*var): #adding new customer data to the system, length of var = 8
